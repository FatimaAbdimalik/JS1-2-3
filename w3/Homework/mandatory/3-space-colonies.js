...
//In this solution, we used filter to create a new array which contains what we want. CharAt() is a string method which take the index of each letter. For infos Google.
