...
// 3) Sort array of letters alphabetically
//    Hint: use the Array method sort()
//    Remember to Google how to use sort method
function sortArray() {
  let letters = ["asdad", "n", "c", "e", "z", "f"];
  let sortedLetters = letters.sort();

  return sortedLetters;
}
//unicode decimal, unless you're passing comparing function--UTF 16
...
function first5() {
  ...
  //you could splice the last items as well
