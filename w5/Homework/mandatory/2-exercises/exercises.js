...
function insertPeopleData(arrayOfPeople) {
 ...
 /*solution 2*/
  ...
  //   let titl1 = document.createElement("h1");
  //   titl1.textContent = arrayOfPeople[i].name;
  //   let titl2 = document.createElement("h2");
  //   titl2.textContent = arrayOfPeople[i].job;
  //   content.appendChild(titl1);
